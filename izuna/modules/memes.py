...
import izuna.modules.helper_funcs.fun_strings as fun
from izuna import DEV_USERS, LOGGER, SUDO_USERS, SUPPORT_USERS, dispatcher
from izuna.modules.disable import (
    DisableAbleCommandHandler,
    DisableAbleMessageHandler,
)
from izuna.modules.helper_funcs.alternate import typing_action
from izuna.modules.helper_funcs.extraction import extract_user
...
`/decide` can be also used with regex like: `izuna What? <question>: randomly answer "Yes, No" etc.`
...
DECIDE_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(izuna)"), decide, friendly="decide", run_async=True
)
