...
from izuna.modules import ALL_MODULES
from izuna.modules.helper_funcs.chat_status import is_user_admin
from izuna.modules.helper_funcs.filters import CustomFilters
from izuna.modules.helper_funcs.misc import paginate_modules
from izuna.modules.helper_funcs.alternate import typing_action


PM_START_TEXT = f"""
Hey Qicek! my name is *{dispatcher.bot.first_name}*.
Terimakasih Sudah menekan start? gunakan /help

Join Our [GROUP](https://t.me/Temengoblok) 

Tambahkan bot ini ke grup dan jangan lupa kasih akses admin!
SIAP DENGAN SENANG HATI MELAYANI ANDA 🙂:

• Subscribe my channel.         • https://www.youtube.com/channel/UCzc28Jfen5ScSSBXZPJVyZw
• Media Partners.   • Ｔｅｍａｎ Ｈａｌｕｕ

*Managed With ❤️ By :* [Public Enemy](https://t.me/al_cuteid)
...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group 👥", url="t.me/IzunaTelebot?startgroup=true"
        ),
        InlineKeyboardButton(
            text="Gban Logs 🚫", url="https://t.me/izunalogs"
        ),
    ]
]
...
buttons += [
    [
        ...
        InlineKeyboardButton(
            text="Support Group 🐨", url="https://t.me/Temengoblok"
        ),
    ]
]
...
buttons += [
    [
        InlineKeyboardButton(
            text="Yotube Channel 🌐",
            url="https://www.youtube.com/channel/UCzc28Jfen5ScSSBXZPJVyZw"
        ),
        InlineKeyboardButton(
            text="Support Channel ✨FREINDSHIP✨", url="https://t.me/freindshipindo"
        ),
    ]
]
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                "https://i.ibb.co/2MSkQh4/oke.jpg",
                PM_START_TEXT,
