# IZUNATELEBOT BOT BASE USERBOTINDO
...
![logo](https://i.ibb.co/2MSkQh4/oke.jpg)
...
Can be found on telegram as [Public Enemy](https://t.me/al_cuteid).

Join the [Group Support](https://t.me/Temengoblok) if you just want to stay in the loop about new features or announcements.
...
This file should be placed in your `izuna` folder, alongside the `__main__.py` file.
...
Alternatively, [find me on telegram](https://t.me/al_cuteid)! (Keep all support questions in the support chat, where more people can help you.)
...
```python
    ...
    OWNER_USERNAME = "al_cuteid" # your telegram username
